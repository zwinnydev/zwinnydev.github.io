...
export default {
  ...
  highlight_code_bg: colors.primary,
  highlight_code_marker: colors.primary,
  highlight_code_linebg: '#022a4b',
  socialMediaCardFilter: '#437abf', // #8f43bf
  postMetadata: colors.primary,
  blockquoteBackground: colors.backgroundArticle,
  tdBackground: colors.backgroundArticle,
  blockquoteColor: colors.blockquoteColor,
}
